  ...
  return (
    ...
    >
      ...
      <div className="pointer-events-none absolute inset-0 overflow-hidden">
        ...
        <span className="hero-focus-ring absolute right-[25%] top-[40%] hidden size-40 rounded-full border border-wm-red/40 lg:block" />
        <span className="hero-corner hero-corner-left absolute left-0 top-1/2 hidden h-px w-56 bg-gradient-to-r from-white/30 to-transparent lg:block" />
        <span className="hero-corner hero-corner-right absolute right-0 top-[30%] hidden h-px w-64 bg-gradient-to-l from-wm-red/40 to-transparent lg:block" />
      </div>

      <div className="wm-container relative z-10 py-24">
        <div className="hero-copy max-w-4xl">
          <p className="hero-reveal inline-flex rounded-[8px] border border-wm-red/40 bg-wm-red/15 px-3 py-2 text-xs font-black uppercase tracking-[0.16em] text-white">
            Sport, wedding, and event photographer
          </p>
          <p className="hero-reveal mt-8 text-sm font-bold uppercase tracking-[0.24em] text-wm-gold">
            Capture Your Moment
          </p>
          <h1 className="hero-reveal hero-title-glow mt-4 text-6xl font-black leading-[0.92] tracking-normal text-white sm:text-7xl lg:text-8xl">
            WMfilms
          </h1>
          <p className="hero-reveal mt-6 max-w-2xl text-base leading-8 text-zinc-200 sm:text-xl">
